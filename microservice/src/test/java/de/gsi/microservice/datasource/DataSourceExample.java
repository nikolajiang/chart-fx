...
public class DataSourceExample {
    ...
    public static void main(String[] args) throws DirectoryLightClient.DirectoryClientException {
        ...
        final String address = directoryLightClient.getDeviceInfo(Collections.singletonList(DEV_NAME)).get(0).getAddress();
        dataSourcePublisher.subscribe(address, DEV_NAME, PROP, SELECTOR, Map.of("acquisitionModeFilter", 0, "channelNameFilter", "GS11MU2:Current_1@10Hz"), CmwLightExample.AcquisitionDAQ.class);
        // run the publisher's main loop
        dataSourcePublisher.run();
    }
}
